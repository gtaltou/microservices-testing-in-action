...
import com.taltou.customerservice.service.CustomerService;
...
class CustomerRestControllerTest {
    ...
    void setUp() {
        this.customers = List.of(
                ...
                CustomerDTO.builder().id(3L).firstName("ted").lastName("jonhson").email("tjonhson@gmail.com").build()
        );
    }
    ...
    void shouldSaveCustomer() throws Exception {
        ...
        String expected = """
                {
                  "id":1, "firstName":"guy", "lastName":"taltou", "email":"gtaltou@gmail.com"
                }
                """;
